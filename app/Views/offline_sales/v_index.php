  ...
  <div class="card-body pt-0 pb-2">
    ...
    <form action="<?= base_url('/offline-sales') ?>" method="get" class="row g-2 mb-4 align-items-end">
      ...
      <div class="col-lg-3 col-md-12 col-12 d-flex gap-2 mt-lg-0 mt-3">
        ...
        <a href="<?= base_url('/offline-sales') ?>" class="btn btn-sm btn-outline-secondary mb-0 d-flex align-items-center justify-content-center gap-1" style="height: 31px;" title="Reset">
