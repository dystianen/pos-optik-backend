    ...
    <div class="card-body">
      ...
      <form action="<?= base_url('/reports/sales') ?>" method="get" class="row g-3 align-items-end">
        ...
        <div class="col-lg-3 col-md-12 col-12 d-flex gap-2 mt-lg-0 mt-3">
          ...
          <a href="<?= base_url('/reports/sales') ?>" class="btn btn-sm btn-outline-secondary mb-0 d-flex align-items-center justify-content-center gap-1" style="height: 31px; border-radius: 8px;" title="Reset">
